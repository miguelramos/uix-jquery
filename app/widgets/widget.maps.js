 ...
 * @version 0.0.3
 */
var MAP_PIN = 'M0-165c-27.618 0-50 21.966-50 49.054C-50-88.849 0 0 0 0s50-88.849 50-115.946C50-143.034 27.605-165 0-165z';//34x55
  ...
  $.widget("uix.maps", {
    ...
    addMarker: function(options){
      var defaults = {
        ...
        'title': 'Map Icons',
        'map': this.gmap,
        'position':  new google.maps.LatLng(41.358773,-8.753555),
        'icon': {
          path: MAP_PIN,
          fillColor: '#0E77E9',
          fillOpacity: 1,
      ...
      var marker = new Marker(defaults);//google.maps.Marker(options);//Marker(options);
      console.log(marker);
    },
    getMap: function(){
      return this.gmap;
