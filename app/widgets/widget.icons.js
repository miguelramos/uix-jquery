    ...
    $.widget("uix.icons", {
        ...
        _create: function() {
            ...
            var model = this._createModel(),
                containerIcons = null,
                hiddenIcon = $('input').tag({
                    'name': 'icon[]',
                    'type': 'hidden',
                    'class': 'id-icon-select'
                }),
                hiddenColor = $('input').tag({
                    'name': 'color[]',
                    'type': 'hidden',
                    'class': 'id-color-select'
                }),
                map = [],
                self = this;
            ...
            $.each(this.options.icons, function(index, value) {
                ...
                icon.append($(self.options.tag).tag({
                    'class': value
                }));
            ...
            containerIcons.append(hiddenIcon).append(hiddenColor).append($('div').tag({
                'class': 'clearfix'
            }));
        ...
        _setupIcons: function(map) {
            var container = $('div').tag({
                'class': 'uix-icon-container'
            }),
                itemSelect = $('div').tag({
                    'class': 'ui-icon-check'
                }).append($('i').tag({
            ...
            $.each(map, function(index, icon) {
                ...
                icon.on('click', function(evt) {
                    ...
                    self._trigger('check', evt, {
                        'icon': self.options.selected
                    });
                });
